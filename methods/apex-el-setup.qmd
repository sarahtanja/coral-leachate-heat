...
-   bring out Apex el, EnergyBar, aquabus cable and ethernet cable but don't connect anything yet

-   be prepared to connect your phone to the network from the router you plan to plug into

-   open Apex app

-   go to `link apex` for a new aquarium setup

-   name the apex

-   select Apex A2 series, APEX el

-   When prompted with 'How should Apex connect to the internet?' select connect Apex via ethernet

-   connect Apex to EnergyBar via Aquabus from the Apex side first

-   Connect EnergyBar to power

-    JPG_FIELD_APEX AC5L:36665
